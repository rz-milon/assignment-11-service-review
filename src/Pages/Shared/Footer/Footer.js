...
const Footer = () => {
    return (
        <footer className="footer footer-center p-10 bg-black text-white">
            ...
            <div>
                <p>Copyright © 2022 - All right reserved by <Link className='text-3xl tracking-wide font-bold text-[#5e03fc] hover:text-green-800 ml-2' to='/'>Al Farabi Photography</Link></p>
            </div>
        </footer>
    );
};
